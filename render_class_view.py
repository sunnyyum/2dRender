...
parser.add_argument('-oc', '--object_color', help='Object(Mesh) Color', default='1.0,1.0,1.0')
...
view_bg_color = [c for c in args.background_color.split(',')]
view_obj_color = [o for o in args.object_color.split(',')]
...
view_fout.write(' '.join([args.azimuth, args.elevation, args.tilt, args.distance,
                          view_bg_color[0], view_bg_color[1], view_bg_color[2],
                          view_obj_color[0], view_obj_color[1], view_obj_color[2]]))
view_fout.close()
